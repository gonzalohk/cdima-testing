...
import { exportDiplomadoGeneralPDF, exportDiplomadoGeneralWord, exportDiplomadoCentralizadorNotasPDF, exportDiplomadoCentralizadorNotasWord, exportDiplomadoEstudiantePDF, exportDiplomadoEstudianteWord, exportDiplomadoNominaPDF, exportDiplomadoNominaWord, exportDiplomadoAsistenciaPDF, exportDiplomadoAsistenciaWord } from '../services/reports/diplomados-reports.service';
...
const DiplomadosPage: React.FC = () => {
  ...
  const handleExportNominaPDF = () => {
    if (!selectedDiplomado || estudiantes.length === 0) return;
    try {
      exportDiplomadoNominaPDF({ diplomado: selectedDiplomado, estudiantes });
    } catch (error) {
  ...
  const handleExportNominaWord = () => {
    if (!selectedDiplomado || estudiantes.length === 0) return;
    try {
      exportDiplomadoNominaWord({ diplomado: selectedDiplomado, estudiantes });
    } catch (error) {
  ...
  const handleExportAsistenciaPDF = () => {
    if (!selectedDiplomado || estudiantes.length === 0) return;
    try {
      exportDiplomadoAsistenciaPDF({ diplomado: selectedDiplomado, estudiantes });
    } catch (error) {
  ...
  const handleExportAsistenciaWord = () => {
    if (!selectedDiplomado || estudiantes.length === 0) return;
    try {
      exportDiplomadoAsistenciaWord({ diplomado: selectedDiplomado, estudiantes });
    } catch (error) {
